...
<body>
  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top mb-5">
    <div class="container">
      <ul class="navbar-nav mr-auto">
        <li class="nav-item ">
          <a class="navbar-brand" href="<?= BASEURL ?>/pencarian/index">WOC Manajemen Administarsi</a>
        </li>

        <li class="nav-item ">
          <a class="navbar-brand" href="<?= BASEURL ?>/user">Tambah User</a>
        </li>
      </ul>

      <ul style="padding-left: 600px;" class="navbar-nav mr-auto">
        <li class="nav-item active dropdown">
          ...
          <div class="dropdown-menu">
            ...
            <a class="dropdown-item" data-toggle="modal" data-target="#formModalubhpswd">Ubah Password</a>
          </div>
        </li>
      </ul>
    </div>
  ...
  <!-- modal ubah password -->
  <div class="modal fade" id="formModalubhpswd" tabindex="-1" role="dialog" aria-labelledby="judulModal" aria-hidden="true">
